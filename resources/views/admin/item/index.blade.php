                    ...
                    <table class="table table-striped table-bordered"  id="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                        	<td>{{ $key+1 }}</td>
                        	<td>{{ $item->name }}</td>
                          <td><img src="{{ asset('uploads/item/'.$item->image) }}" style="height:70px; width: auto;" alt=""></td>
                          <td>{{ $item->price }}</td>
                          <td>{{ $item->category->name }}</td>
                           ...
                           <button class="btn btn-danger" type="button" onclick="if (confirm('Are you sure to delete this item????')){
